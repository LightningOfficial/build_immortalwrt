...
# 修改闭源驱动2G wifi名称
sed -i 's/SSID1=CR660X_2.4G/SSID1=JCG-Q20/g' package/mtk/mtkhqos_util/files/mt7615.1.2G.dat

# 修改闭源驱动5G wifi名称
sed -i 's/SSID1=Openwrt_5G/SSID1=JCG-Q20-5G/g' package/mtk/mtkhqos_util/files/mt7615.1.5G.dat
